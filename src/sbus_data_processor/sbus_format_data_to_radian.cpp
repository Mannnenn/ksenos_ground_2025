...
{
public:
    SbusDataProcessor(const rclcpp::NodeOptions &options = rclcpp::NodeOptions()) : Node("sbus_data_processor", options)
    {
        // パブリッシャーの作成
...
RCLCPP_COMPONENTS_REGISTER_NODE(SbusDataProcessor)